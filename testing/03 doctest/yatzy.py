...
def small_straight(dice):
    """Score given roll in the 'Small straight' Yatzy category.
    ...
    15
    >>> small_straight([1, 2, 3, 3, 5])
    0

    This function only works with lists, sets, or other collection types:
...
def scores_in_categories2(dice, categories=ALL_CATEGORIES):
    """Score the dice in each category and return those with a non-zero score. 
